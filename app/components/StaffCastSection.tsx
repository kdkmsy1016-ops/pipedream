...
const STAFF_MEMBERS = [
    {
        ...
        comment: "「夢」という言葉には、<br>人を前に進ませる力と、<br>現実から遠ざけてしまう危うさの<br>両方があると思っています。<br>この作品は、夢と現実の間で悩み、<br>環境や現状に揺れながらも<br>前に進もうとする人々が、<br>そこから脱却を目指す物語です。<br>この物語が、誰かの中にある<br>“まだ手放していない夢”に<br>触れることができたら嬉しいです。"
    }
];
